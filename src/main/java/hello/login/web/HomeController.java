...
/*
    ...
    /*@GetMapping("/")*/
    public String homeLoginV3Spring(@SessionAttribute(name = SessionConst.LOGIN_MEMBER,required = false) Member session,
                              Model model) {
    ...
    @GetMapping("/")
    public String homeLoginV4(@Login Member session,
                                    Model model) {
